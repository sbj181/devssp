...
?>
		<div style="display:table;table-layout:fixed;width:100%;float:left;padding:1% 2.5% 2em 2.5%;overflow:hidden;" id="form_wrapper">
				<font size='3'><a href='https://app.blogvault.net' target="_blank">Click here</a> to manage backups & security of your sites from the <a href='https://app.blogvault.net' target="_blank">BlogVault Dashboard.</a></font>
				<br/><br/>
