				...
				if( $posts ): ?>
					...
					<?php foreach( $posts as $p ): // variable must NOT be called $post (IMPORTANT) ?>
						<div class="col-sm-6 relatedposts">
							<a href="<?php echo get_permalink( $p->ID ); ?>"><div class="associated-posts" style="background-image: url(<?php if (  (function_exists('has_post_thumbnail')) && (has_post_thumbnail( $p->ID ))  ) { //inserts first embedded image as featured
					  				echo get_the_post_thumbnail_url( $p->ID );
									} else {
					   				echo 'http://sspinnovations.com/wp-content/uploads/2017/12/156233_BlogPostFeatureImages5_120517.jpg'; /* main_image();*/
									} ?>) !important;"></div></a>
