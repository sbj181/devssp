...
$company = isset( $user ) ? $user->user_company : '';
...
<form id="edd_free_download_form" method="post">
	...
	<p>
		<label for="edd_free_download_company" class="edd-free-downloads-label"><?php echo __( 'Company', 'edd-free-downloads' ) . $rname; ?></label>
		<input type="text" name="edd_free_download_company" id="edd_free_download_company" class="edd-free-download-field" placeholder="<?php _e( 'Company', 'edd-free-downloads' ); ?>" value="<?php echo $company; ?>" />
	</p>
	<?php endif; ?>
