...
<div class="service-header row align-items-center" data-parallax="scroll" data-speed="0.5" data-image-src="<?php echo get_the_post_thumbnail_url('2556'); ?>">
  <div class="col-md-12">
    <div class="container">
      <h1 class="blogheader">
        <?php the_field('hero_headline', 2556); ?>
      </h1>
      <h2 class="blogheader">
        <?php the_field('hero_subhead', 2556); ?>
      </h2>
    </div>
  </div>
</div>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <div class="container childPages">
    <?php
    $posts = get_field('section_child_pages', 2556);
    if( $posts ): ?>
