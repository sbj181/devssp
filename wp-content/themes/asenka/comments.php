...
<div id="comments" class="comments-area">
    ...
    if ( have_comments() ) : ?>
        ...
        <h2 class="comments-title">
            ...
            if ( '1' === $comments_number ) {
                ...
                printf( _x( 'One comment', 'comments title', 'wp-bootstrap-starter' ), get_the_title() );
            } else {
                printf(
    ...
    <?php comment_form( $args = array(
        ...
        'title_reply'       => __( 'Leave a comment, and share your thoughts', 'wp-bootstrap-starter' ),  // that's the wordpress default value! delete it or edit it ;)
        'title_reply_to'    => __( 'Leave a comment and share your thoughts to %s', 'wp-bootstrap-starter' ),  // that's the wordpress default value! delete it or edit it ;)
        ...
        'comment_field' =>  '<p><textarea placeholder="Message..." id="comment" class="form-control" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>',
